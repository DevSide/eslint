...
const VALID_TEMPLATE_ESCAPES = VALID_STRING_ESCAPES.concat([
    "$",
    "{",
    "}"
]);
...
module.exports = {
    ...
    create(context) {
        ...
        function validate(escapes, node, elm) {
            ...
            const isQuoteEscape = node.type === "TemplateElement"
                ? elm[0][1] === "`"
                : elm[0][1] === node.raw[0];
        ...
        function check(node) {
            ...
            if (typeof node.value === "string") {
                 ...
                 * This does not apply to template literals as backticks are not supported by JSX yet: https://github.com/facebook/jsx/issues/25.
                 */
                ...
                nodeEscapes = VALID_TEMPLATE_ESCAPES;
